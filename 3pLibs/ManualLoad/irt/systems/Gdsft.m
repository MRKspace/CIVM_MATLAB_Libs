...
if ~arg.use_mex
	forw = @(arg, x) dtft(x, arg.om_t', 'n_shift', arg.n_shift,arg.useloop);
	back = @(arg, y) fatrix2_maskit(arg.mask, ...
		dtft_adj(y, arg.om_t', arg.Nd, arg.n_shift,arg.useloop));
...
if arg.use_mex
	...
	y = dtft(x, arg.om_t', 'n_shift', arg.n_shift,arg.useloop);
end
y = arg.phasor * y;
...
if arg.use_mex
	...
	x = dtft_adj(y, arg.om_t', arg.Nd, arg.n_shift,arg.useloop);
end
