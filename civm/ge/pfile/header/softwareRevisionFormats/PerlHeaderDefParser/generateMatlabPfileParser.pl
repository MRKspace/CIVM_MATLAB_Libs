...
my $rdb_header_rec_function = "ge_read_rdb_header_rec_rdb$revision_number_prefix";
...
my $exam_header_function = "ge_read_exam_header_rdb$revision_number_prefix";
...
my $series_header_function = "ge_read_series_header_rdb$revision_number_prefix";
...
my $image_header_function = "ge_read_image_header_rdb$revision_number_prefix";
