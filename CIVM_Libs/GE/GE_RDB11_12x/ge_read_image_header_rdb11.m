...
strct = setfield(strct, 'xmtfreq', fread(fid,1,'int32',byte_order)); % Center Frequency (0.1 Hz)
strct = setfield(strct, 'autoxmtfreq', fread(fid,1,'int32',byte_order)); % Auto Center Frequency (0.1 Hz)
...
strct = setfield(strct, 'xmtgain', fread(fid,1,'int16',byte_order)); % Actual Transmit Gain (.1 db)
strct = setfield(strct, 'rcvgain1', fread(fid,1,'int16',byte_order)); % Actual Receive Gain Analog (.1 db)
strct = setfield(strct, 'rcvgain2', fread(fid,1,'int16',byte_order)); % Actual Receive Gain Digital (.1 db)
...
strct = setfield(strct, 'autoxmtgain', fread(fid,1,'int16',byte_order)); % Auto Transmit Gain (0.1 dB)
strct = setfield(strct, 'prescan_r1', fread(fid,1,'int16',byte_order)); % PreScan R1 - Analog
strct = setfield(strct, 'prescan_r2', fread(fid,1,'int16',byte_order)); % PreScan R2 - Digital
...
strct = setfield(strct, 'ps_flag', fread(fid,1,'int16',byte_order)); % Auto/Manual Prescan flag
strct = setfield(strct, 'ps_status', fread(fid,1,'int16',byte_order)); % Bitmap of changed values
...
strct = setfield(strct, 'asoffsetx', fread(fid,1,'int16',byte_order)); % gradient offset in X-direction
strct = setfield(strct, 'asoffsety', fread(fid,1,'int16',byte_order)); % gradient offset in Y-direction
strct = setfield(strct, 'asoffsetz', fread(fid,1,'int16',byte_order)); % gradient offset in Z-direction
...
strct = setfield(strct, 'sys_type', char(fread(fid,64,'char',byte_order)));
strct = setfield(strct, 'xml_psc_shm_vol', char(fread(fid,32,'char',byte_order)));
strct = setfield(strct, 'img_hdr_padding', char(fread(fid,164,'char',byte_order)));
